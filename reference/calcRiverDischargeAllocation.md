...
This function distributes surplus basin discharge after the previous
river routings following certain management assumptions
...
- allocationrule:
  ...
  Rule to be applied for river basin discharge allocation

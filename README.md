...
R package **mrwater**, version **1.13.7.9004**
...
Beier F, Heinke J, Karstens K, Bodirsky B, Dietrich J (2024). _mrwater: madrat based MAgPIE water Input Data Library_. R package version 1.13.7.9004, <https://github.com/pik-piam/mrwater>.
...
@Manual{,
  ...
  year = {2024},
  note = {R package version 1.13.7.9004},
